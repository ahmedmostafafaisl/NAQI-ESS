...
<?php $__env->startSection('content'); ?>
    <form method="POST" action="<?php echo e(route('admin.permissions.store')); ?>"
        ...
        <?php echo csrf_field(); ?>
        <input type="text" name="name" placeholder="<?php echo e(__('admin.permissions.name_placeholder')); ?>" required
            class="flex-1 rounded-lg border border-slate-300 px-4 py-2 text-sm">
        <button
            class="bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2 rounded-lg text-sm"><?php echo e(__('admin.permissions.add')); ?></button>
    </form>
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <table class="w-full text-sm">
            <thead class="bg-slate-50 text-slate-500">
                <tr>
                    <th class="px-5 py-3 text-start"><?php echo e(__('admin.permissions.title')); ?></th>
                    ...
                    <tr>
                        ...
                        <td class="px-5 py-3 text-end">
                            <form action="<?php echo e(route('admin.permissions.destroy', $permission)); ?>" method="POST"
                                class="inline-block" onsubmit="return confirm('<?php echo e(__('admin.common.confirm_delete')); ?>')">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/faisal/new dev/DEV/Naqi/naqi-ess-prod/resources/views/permissions/index.blade.php ENDPATH**/ ?>